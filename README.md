...
A new parameter called `codeSamplesLanguage` was added to `options` Object to provide code sample generation. You can pass an array like this to enable all languages supported by the code generation:
