...
if (typeof Element !== 'undefined' && !Element.prototype.scrollIntoViewIfNeeded) {
  Element.prototype.scrollIntoViewIfNeeded = function (centerIfNeeded) {
    ...
    const overTop = (this as HTMLElement).offsetTop - parent.offsetTop < parent.scrollTop;
    const overBottom =
      (this as HTMLElement).offsetTop -
        parent.offsetTop +
        this.clientHeight -
        parentBorderTopWidth >
      parent.scrollTop + parent.clientHeight;
    const overLeft = (this as HTMLElement).offsetLeft - parent.offsetLeft < parent.scrollLeft;
    const overRight =
      (this as HTMLElement).offsetLeft -
        parent.offsetLeft +
        this.clientWidth -
